...
<style>
body{background-color:#202020;color:red;}
body,td,th{ font: 9pt Lucida,Verdana;margin:0;vertical-align:top;color:lime; }
table.info{ color:aqua;background-color:#202020; }
span,h1,a{ color: $color !important; }
span{ font-weight: bolder; }
h1{ border-left:5px solid $color;padding: 2px 5px;font: 14pt Verdana;background-color:#202020;margin:0px; }
div.content{ padding: 5px;margin-left:5px;background-color:#202020; }
a{ text-decoration:none; }
a:hover{ text-decoration:underline; }
#pre{font.family:Courier,Monospace;}
.ml1{ border:1px solid teal;padding:5px;margin:0;overflow: auto; }
.bigarea{ width:100%;height:300px; }
input,textarea,select{ margin:0;color:lime;background-color:#202020;border:1px solid $color; font: 9pt Monospace,'Courier New'; }
form{ margin:0px; }
#toolsTbl{ text-align:center; }
.toolsInp{ width: 300px }
.main th{text-align:left;background-color:#202020;}
.main tr:hover{background-color:#202020}
.l1{background-color:#202020}
.l2{background-color:#202020}
pre{font-family:Courier,Monospace;}
</style>
<script>
